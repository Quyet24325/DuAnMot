...
class CouponAdminController extends coupons
{
    ...
    public function addCoupon()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['addCoupon'])) {
            ...
            $createNewCoupon = $this->createCoupon($_POST['name'], $_POST['coupon_code'], $_POST['type'], $_POST['star_date'], $_POST['end_date'], $_POST['quantity'], $_POST['status']);
            if ($createNewCoupon) {
    ...
    public function update()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['updateCoupon'])) {
            ...
            $_SESSION['errors'] = $errors;
            $updateVoucher = $this->updateCoupon($_GET['id'], $_POST['name'], $_POST['coupon_code'], $_POST['type'], $_POST['star_date'], $_POST['end_date'], $_POST['quantity'], $_POST['status']);
            if ($updateVoucher) {
